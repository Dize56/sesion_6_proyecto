...
def main(config_path: str):
    ...
    output_path = evaluation_config.get("output_path") or evaluation_config.get("outputs_path")
    if output_path is None:
        raise KeyError(
            "La configuración de evaluación debe incluir 'output_path' dentro de 'evaluation'."
        )
